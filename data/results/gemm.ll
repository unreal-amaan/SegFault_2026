; ModuleID = '/home/syed/Amaan/amaan_codes/compilers/compiler-cost-model-data/benchmarks/polybench/linear-algebra/blas/gemm/gemm.c'
source_filename = "/home/syed/Amaan/amaan_codes/compilers/compiler-cost-model-data/benchmarks/polybench/linear-algebra/blas/gemm/gemm.c"
...
for.cond34:                                       ; preds = %for.inc62, %for.end33
...
for.cond38:                                       ; preds = %for.inc59, %for.body37
  %30 = load i32, ptr %i, align 4
  %31 = load i32, ptr %nk.addr, align 4
...
for.cond42:                                       ; preds = %for.inc56, %for.body41
  %32 = load i32, ptr %j, align 4
  %33 = load i32, ptr %nj.addr, align 4
  %cmp43 = icmp slt i32 %32, %33
  br i1 %cmp43, label %for.body45, label %for.end58

for.body45:                                       ; preds = %for.cond42
  %34 = load i32, ptr %i, align 4
  %35 = load i32, ptr %j, align 4
  %add46 = add nsw i32 %35, 2
  %mul47 = mul nsw i32 %34, %add46
  %36 = load i32, ptr %nj.addr, align 4
  %rem48 = srem i32 %mul47, %36
  ...
  %arrayidx53 = getelementptr inbounds [1100 x double], ptr %38, i64 %idxprom52
  %40 = load i32, ptr %j, align 4
  %idxprom54 = sext i32 %40 to i64
  %arrayidx55 = getelementptr inbounds [1100 x double], ptr %arrayidx53, i64 0, i64 %idxprom54
  store double %div51, ptr %arrayidx55, align 8
  br label %for.inc56
